...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class QueuePaginatedList :  IEquatable<QueuePaginatedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueuePaginatedList" /> class.
        /// </summary>
        ...
        public QueuePaginatedList(int? pageNumber = default(int?), int? pageSize = default(int?), int? totalCount = default(int?), List<Queue> items = default(List<Queue>), int? completed = default(int?), int? started = default(int?), int? impediments = default(int?), Guid? parentId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueuePaginatedList {\n");
        ...
        {
            return this.Equals(input as QueuePaginatedList);
        }

        /// <summary>
        /// Returns true if QueuePaginatedList instances are equal
        /// </summary>
        /// <param name="input">Instance of QueuePaginatedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueuePaginatedList input)
        {
            if (input == null)
                return false;
