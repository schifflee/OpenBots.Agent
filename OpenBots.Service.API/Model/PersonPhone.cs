...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PersonPhone :  IEquatable<PersonPhone>, IValidatableObject
    {
        /// <summary>
        ...
        public PersonPhone(Guid? personId = default(Guid?), string phoneNumber = default(string), Person person = default(Person), Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string))
        {
            // to ensure "personId" is required (not null)
            if (personId == null)
            {
                throw new InvalidDataException("personId is a required property for PersonPhone and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PersonPhone);
        }

        /// <summary>
        /// Returns true if PersonPhone instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonPhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonPhone input)
        {
            if (input == null)
                return false;
