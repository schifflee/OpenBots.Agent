...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AuditLogPaginatedList :  IEquatable<AuditLogPaginatedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogPaginatedList" /> class.
        /// </summary>
        ...
        public AuditLogPaginatedList(int? pageNumber = default(int?), int? pageSize = default(int?), int? totalCount = default(int?), List<AuditLog> items = default(List<AuditLog>), int? completed = default(int?), int? started = default(int?), int? impediments = default(int?), Guid? parentId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogPaginatedList {\n");
        ...
        {
            return this.Equals(input as AuditLogPaginatedList);
        }

        /// <summary>
        /// Returns true if AuditLogPaginatedList instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditLogPaginatedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditLogPaginatedList input)
        {
            if (input == null)
                return false;
