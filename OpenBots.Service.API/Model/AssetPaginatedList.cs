...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssetPaginatedList :  IEquatable<AssetPaginatedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetPaginatedList" /> class.
        /// </summary>
        ...
        public AssetPaginatedList(int? pageNumber = default(int?), int? pageSize = default(int?), int? totalCount = default(int?), List<Asset> items = default(List<Asset>), int? completed = default(int?), int? started = default(int?), int? impediments = default(int?), Guid? parentId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetPaginatedList {\n");
        ...
        {
            return this.Equals(input as AssetPaginatedList);
        }

        /// <summary>
        /// Returns true if AssetPaginatedList instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetPaginatedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetPaginatedList input)
        {
            if (input == null)
                return false;
