...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JobPaginatedList :  IEquatable<JobPaginatedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobPaginatedList" /> class.
        /// </summary>
        ...
        public JobPaginatedList(int? pageNumber = default(int?), int? pageSize = default(int?), int? totalCount = default(int?), List<Job> items = default(List<Job>), int? completed = default(int?), int? started = default(int?), int? impediments = default(int?), Guid? parentId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobPaginatedList {\n");
        ...
        {
            return this.Equals(input as JobPaginatedList);
        }

        /// <summary>
        /// Returns true if JobPaginatedList instances are equal
        /// </summary>
        /// <param name="input">Instance of JobPaginatedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobPaginatedList input)
        {
            if (input == null)
                return false;
